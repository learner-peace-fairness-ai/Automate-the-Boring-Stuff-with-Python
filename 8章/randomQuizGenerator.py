...
capitals = {'北海道': '札幌市',
             ...
             '茨木県': '水戸市', '栃木県': '宇都宮市', '群馬県': '前橋市', '埼玉県': 'さいたま市', '千葉県': '千葉市', '東京都': '東京', '神奈川県': '横浜市',
...
for quiz_num in range(35):
    ...
    # 問題集のヘッダーを書く
    quiz_file.write('名前\n\n日付\n\n学期\n\n')
    quiz_file.write(f'{' ' * 20}都道府県庁所在地クイズ （問題番号 {quiz_num + 1}）')
    quiz_file.write('\n\n')
    ...
    for question_num in range(len(prefectures)):
        ...
        # 問題文と解答選択肢を問題ファイルに書く
        quiz_file.write(f'{question_num + 1}. {prefectures[question_num]}の都道府県所在地は？\n')
        for i in range(4):
